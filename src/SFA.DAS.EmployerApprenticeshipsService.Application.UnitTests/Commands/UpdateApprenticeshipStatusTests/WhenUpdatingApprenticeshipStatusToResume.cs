...
{
    [TestFixture]
    public sealed class WhenUpdatingApprenticeshipStatusToResume
    {
        ...
        public void Setup()
        {
            ...
            _testApprenticeship = new Apprenticeship { StartDate = DateTime.UtcNow.AddMonths(-2).Date, PaymentStatus = PaymentStatus.Paused};
        ...
        public async Task ShouldSendProviderNotification()
        {
            ...
            _providerEmailNotificationService.Verify(x =>
                    x.SendProviderApprenticeshipResumeNotification(It.Is<Apprenticeship>(a => a == _testApprenticeship),
