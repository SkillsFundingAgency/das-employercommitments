    ...
    public class ApprenticeshipCoreValidator : AbstractValidator<ApprenticeshipViewModel>, IApprenticeshipCoreValidator
    {
        ...
        protected virtual void ValidateStartDate()
        {
            RuleFor(x => x.StartDate)
                ...
                .Must(StartDateForTransferNotBeforeMay2018).WithMessage(_validationText.LearnStartDateBeforeTransfersStart.Text).WithErrorCode(_validationText.LearnStartDateBeforeTransfersStart.ErrorCode)
